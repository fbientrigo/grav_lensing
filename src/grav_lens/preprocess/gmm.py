...
def reconstruct_lowfreq_from_pca(principal_components, batch_size, ipca_low):
    """
...
def reconstruct_batch_images(principal_components, gaussians, batch_size, ipca_low, image_shape=(128, 128)):
    """
